    ...
    return (
        <>
            <ProductSchema
                ...
                price={product.price}
                currency="USD"
                image={product.image?.startsWith('/') ? `https://thequickbook.com${product.image}` : product.image}
                url={`https://thequickbook.com/shop/${product.id}`}
                sku={product.id}
                brand="QuickBooks"
            />
            <BreadcrumbSchema
                items={[
                    ...
                    { name: "Shop", url: "https://thequickbook.com/shop" },
                    { name: product.category, url: `https://thequickbook.com/shop?category=${product.category}` },
                    { name: product.name, url: `https://thequickbook.com/shop/${product.id}` }
                ]}
            />
            <div className="pt-20">
                {/* Hero Section */}
